...
def upgrade() -> None:
    ...
    op.alter_column('cleaning_configs', 'missing_strategy',
               existing_type=sa.VARCHAR(),
               type_=sa.Enum('DROP_ROWS', 'DROP_COLUMN', 'MEAN', 'MEDIAN', 'MODE', 'CONSTANT', 'FORWARD_FILL', name='missingstrategy'),
               existing_nullable=False)
    op.alter_column('cleaning_configs', 'remove_duplicates',
               existing_type=sa.BOOLEAN(),
               nullable=False)
    op.alter_column('cleaning_configs', 'encoding_method',
               existing_type=sa.VARCHAR(),
               type_=sa.Enum('LABEL', 'ONE_HOT', 'ORDINAL', 'BINARY', name='encodingmethod'),
               existing_nullable=False)
    op.alter_column('cleaning_configs', 'scaling_method',
               existing_type=sa.VARCHAR(),
               type_=sa.Enum('MIN_MAX', 'STANDARD', 'ROBUST', 'LOG', name='scalingmethod'),
               existing_nullable=False)
    op.alter_column('cleaning_configs', 'version',
               existing_type=sa.VARCHAR(),
               type_=sa.Enum('V1', 'V2', 'V3', name='cleaningversion'),
               nullable=False)
...
def downgrade() -> None:
    ...
    op.alter_column('cleaning_configs', 'version',
               existing_type=sa.Enum('V1', 'V2', 'V3', name='cleaningversion'),
               type_=sa.VARCHAR(),
               nullable=True)
    op.alter_column('cleaning_configs', 'scaling_method',
               existing_type=sa.Enum('MIN_MAX', 'STANDARD', 'ROBUST', 'LOG', name='scalingmethod'),
               type_=sa.VARCHAR(),
               existing_nullable=False)
    op.alter_column('cleaning_configs', 'encoding_method',
               existing_type=sa.Enum('LABEL', 'ONE_HOT', 'ORDINAL', 'BINARY', name='encodingmethod'),
               type_=sa.VARCHAR(),
               existing_nullable=False)
    op.alter_column('cleaning_configs', 'remove_duplicates',
               existing_type=sa.BOOLEAN(),
               nullable=True)
    op.alter_column('cleaning_configs', 'missing_strategy',
               existing_type=sa.Enum('DROP_ROWS', 'DROP_COLUMN', 'MEAN', 'MEDIAN', 'MODE', 'CONSTANT', 'FORWARD_FILL', name='missingstrategy'),
               type_=sa.VARCHAR(),
               existing_nullable=False)
